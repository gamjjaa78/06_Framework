...
MEMBER_NICKNAME, T0_CHAR(FILE_UPLOAD_DATE, 'YYYY-MM-DD') FILE_UPLOAD_DATE
FROM "UPLOAD_FILE"
JOIN "MEMBER" ON (UPLOAD_FILE.MEMBER_NO="MEMBER".MEMBER_N0)
...
SELECT COUNT(*)
FROM BOARD_TYPE
WHERE BOARD_CODE BETWEEN 4 AND 13;
