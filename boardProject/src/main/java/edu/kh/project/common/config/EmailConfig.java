...
public class EmailConfig {
	...
	public JavaMailSender javaMailSender() {
		...
		// JavaMailSender:이메일 보내는데 사용되는 인터페이스
		// JavaMailSenderImpl 클래스통해 구현
		// SMTP 서버이용해 이메일 보내기 위한 구성 제공
		...
		return mailSender;
		//위처럼 각종 설정이 적용된 JavaMailSender를 Bean으로 등록해
		//Spring 애플리케잉션에서 이메일을 보내기 위한 구성제공
	}
